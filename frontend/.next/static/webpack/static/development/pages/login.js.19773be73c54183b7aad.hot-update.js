...
/* harmony import */ var _config_constants_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../config/constants.js */ "./config/constants.js");
/* harmony import */ var _redux_actions_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../redux/actions.js */ "./redux/actions.js");
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", setLoginData(_babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, loginData, {
                err: _config_strings_js__WEBPACK_IMPORTED_MODULE_9__["ERR_ALL_FIELDS_REQUIRED"],
                msg: ''
              })));
            ...
            case 3:
              ...
              _context.prev = 4;
              _context.next = 7;
              return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_7___default()("".concat(_config_constants_js__WEBPACK_IMPORTED_MODULE_10__["BACKEND"], "/auth/login"), {
                method: 'POST',
                headers: {
            ...
            case 10:
              ...
              if (typeof data.token !== 'undefined') {
                // set cookie
                js_cookie__WEBPACK_IMPORTED_MODULE_8___default.a.set('token', data.token); // save the token for future requests

                props.dispatch(Object(_redux_actions_js__WEBPACK_IMPORTED_MODULE_11__["signedIn"])(data.token));
                redirectToHomeIfLoggedIn();
              }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              return _context2.abrupt("return", setSignupData(_babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, signupData, {
                err: _config_strings_js__WEBPACK_IMPORTED_MODULE_9__["ERR_PASSWORDS_DONT_MATCH"],
                msg: ''
              })));
            ...
            case 5:
              ...
              _context2.prev = 6;
              _context2.next = 9;
              return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_7___default()("".concat(_config_constants_js__WEBPACK_IMPORTED_MODULE_10__["BACKEND"], "/auth/signup"), {
                method: 'POST',
                headers: {
                  'Content-Type': 'application/x-www-form-urlencoded'
                },
            ...
            case 12:
              ...
              if (!(data.message === _config_strings_js__WEBPACK_IMPORTED_MODULE_9__["RESP_API_ERROR"])) {
                _context2.next = 15;
                break;
              }

              return _context2.abrupt("return", setSignupData(_babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, signupData, {
                err: _config_strings_js__WEBPACK_IMPORTED_MODULE_9__["ERR_IN_USER_CREATION"],
                msg: ''
              })));

            case 15:
              if (data.message === _config_strings_js__WEBPACK_IMPORTED_MODULE_9__["RESP_API_USER_CREATED"]) {
                setSignupData(_babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_1___default()({}, defaultSignupData, {
                  err: '',
                  msg: _config_strings_js__WEBPACK_IMPORTED_MODULE_9__["SIGNUP_SUCCESS"]
                }));
              }
...
//# sourceMappingURL=login.js.19773be73c54183b7aad.hot-update.js.map