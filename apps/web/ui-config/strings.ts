...
export const BUTTON_LESSON_DOWNLOAD = "Download file";
...
export const PERM_MEDIA_MANAGE_ANY = "Manage existing files";
export const PERM_MEDIA_VIEW_ANY = "View files";
export const PERM_SITE = "Edit site";
export const PERM_SETTINGS = "Edit settings";
export const PERM_USERS = "Edit users";
...
export const FORM_NEW_PRODUCT_TYPE = "Choose a product";
