...
export const PERM_MAIL_MANAGE = "Manage mails";
export const PERM_MAIL_MANAGE_ANY = "Manage all mails";
...
export const BTN_SEND_MAIL = "Send mail";
...
export const PAGE_HEADER_ALL_MAILS = "All mails";
export const SIDEBAR_MENU_MAILS = "Mails";
export const SIDEBAR_MENU_USERS = "Users";
export const SIDEBAR_MENU_SITE = "Site";
