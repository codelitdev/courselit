                ...
                <div className="space-y-2">
                    <div className="flex flex-col lg:flex-row gap-4 lg:items-center justify-between mb-8">
                        ...
                        <div className="flex gap-2">
                            <Link
                                href={`/dashboard4/page/${pageId}?redirectTo=/dashboard4/community/${id}/manage`}
                            >
                            ...
                            <Link
                                href={`/dashboard4/community/${id}/manage/memberships`}
                            >
                                <Button variant="outline" className="">
                            ...
                            <Link
                                href={`/dashboard4/community/${id}/manage/reports`}
                            >
                                <Button variant="outline" className="">
