                ...
                <>
                    <div className="flex justify-between items-center">
                        ...
                        <Menu2 icon={<MoreVert />} variant="soft">
                            ...
                            <MenuItem>
                                <Link
                                    href={`/dashboard/product/${course?.courseId}/customer/new`}
                                >
                                    {
                                        PRODUCT_TABLE_CONTEXT_MENU_INVITE_A_CUSTOMER
                                    }
                            ...
                            <MenuItem>
                                <Link
                                    href={`/dashboard/page/${course?.pageId}?redirectTo=/dashboard/product/${course?.courseId}?tab=Content`}
                                    className="flex w-full"
                                >
                                    {EDIT_PAGE_MENU_ITEM}
                                </Link>
                    ...
                    >
                        <div className="pt-4">
                            <CourseReports address={address} id={id} />
                        </div>
                        <div className="pt-4">
                            <ContentEditor address={address} id={id} />
                        </div>
                        <div className="pt-4">
                            <PricingEditor
                                address={address}
