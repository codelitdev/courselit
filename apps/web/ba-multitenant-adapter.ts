...
export const mongodbAdapter = (
    ...
    const createCustomAdapter =
        ...
        ({
            ...
            function convertWhereClause({
                ...
                // Push tenant filter to the where clause
                if (als.getStore()?.get("domainId")) {
                    conditions.push({
                        condition: {
                            domain: new ObjectId(
            ...
            return {
                ...
                async findOne({ model, where, select, join }) {
                    ...
                    if (join) {
                        for (const [joinedModel, joinConfig] of Object.entries(
                            join,
                        )) {
    ...
    adapterOptions = {
        config: {
            adapterId: "multitenant-mongodb-adapter",
            adapterName: "Multitenant MongoDB Adapter",
