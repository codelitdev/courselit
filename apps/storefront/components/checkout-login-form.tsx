        ...
        otpStep === "email" ? (
          <form onSubmit={requestOtp} className="flex flex-col gap-3">
            ...
            <LearnerButton
              ...
              disabled={loading}
              className="w-full"
              aria-label={loading ? "Sending" : "Continue with email"}
            >
              {loading ? <CourseLitLoadingIcon size={14} /> : "Continue with email"}
            </LearnerButton>
          </form>
        ) : (
          <form onSubmit={verifyOtp} className="flex flex-col gap-3">
            ...
            <LearnerButton
              ...
              aria-label={loading ? "Verifying" : "Sign in and continue"}
            >
              {loading ? <CourseLitLoadingIcon size={14} /> : "Sign in and continue"}
            </LearnerButton>
            <LearnerButton
              type="button"
              variant="link"
