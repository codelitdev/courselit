...
The core model associates one central account with individual accounts and
roles across multiple schools. A global login does not grant access to every
school, and an administrator is not automatically enrolled in every product.
...
- Community creators appear as members/moderators in the storefront portal.
