...
export const OPERATION_POLICIES = {
  ...
  listProductCustomers: schoolOp(["products:read"]),
  getProductCustomerProgress: schoolOp(["products:read"]),
  ...
  // Contacts admin
  listContacts: schoolOp(["contacts:read"]),
  getContact: schoolOp(["contacts:read"]),
  updateContact: schoolOp(["contacts:write"]),
  updateContactMarketing: schoolOp(["contacts:write"]),
  deleteContact: schoolOp(["contacts:delete"]),
  filterPreviewContacts: schoolOp(["contacts:read"]),
  listContactSegments: schoolOp(["contacts:read"]),
  createContactSegment: schoolOp(["contacts:write"]),
  getContactSegment: schoolOp(["contacts:read"]),
  updateContactSegment: schoolOp(["contacts:write"]),
  deleteContactSegment: schoolOp(["contacts:write"]),
  getContactSegmentMembers: schoolOp(["contacts:read"]),
  grantLearnerMembership: schoolOp(["contacts:write"]),
  createLearnerMembership: schoolOp(["contacts:write"]),
  ...
  subscribeNewsletter: publicOp(),

  // Storefront application endpoints
