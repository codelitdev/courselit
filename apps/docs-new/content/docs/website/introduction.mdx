---
title: Introduction
description: Learn how to use CourseLit's page builder to build landing and sales pages
---

CourseLit comes with a powerful website builder. Using the website builder, you can build all sorts of web pages for various use cases like landing pages, [sales pages](/website/sales-pages), email list builder etc.
