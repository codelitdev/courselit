...
On the left side, you see user's basic details and on the right side you see CourseLit's [permissions editor](/users/permissions) using which you can control what a user can do on your school.
