...
For the latest request and response shapes, see the interactive [API Reference](/api-reference).
...
2. An API key for your domain. Refer to the [introduction section](/developers/introduction) to learn how to obtain your API key.
