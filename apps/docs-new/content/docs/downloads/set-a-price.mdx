...
**In order to get paid for your product, you first need to [set up payments](/schools/set-up-payments). Currently, CourseLit offers [Stripe](https://stripe.com) integration.**
