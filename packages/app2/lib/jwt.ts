...
export default new Strategy(jwtStrategyOptions, function (req: any, jwtToken: { email: string, domain: string }, done: any) {
    ...
    UserModel.findOne({ email, domain, active: true }, function (err: Error, user: User) {
        if (err) {
