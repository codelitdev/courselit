...
import { Action as ToastAction, Root, Description, Provider, Viewport } from "@radix-ui/react-toast";
...
const Toast = ({ message, dispatch, clearMessageAction }: ToastProps) => {
    ...
    <Provider>
        <Root
            ...
            <ToastAction className="[grid-area:_action]" asChild altText="Close">
