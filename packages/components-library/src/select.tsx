import { Dot, Info } from "@courselit/icons";
import {
    Root,
    Trigger,
    Portal,
        ...
        <Root>
            <Trigger asChild>
                <div className="cursor-pointer">
                    ...
                    <div className="flex border border-slate-300 hover:border-slate-400 rounded py-1 px-2 outline-none focus:border-slate-600 disabled:pointer-events-none">
