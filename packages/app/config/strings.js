...
export const GENERIC_COPYRIGHT_TEXT = `Copyright © ${new Date().getFullYear()}`;
...
export const SUBHEADER_BLOG_POSTS_SECTION =
  "Browse our in-depth articles and tutorials.";
...
export const LABEL_NAVIGATION_LINK_TEXT = "Link Text";
export const LABEL_NAVIGATION_LINK_DESTINATION = "URL";
