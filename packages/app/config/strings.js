...
export const USER_ERROR_HEADER = 'Uh oh!'
...
export const SITE_CUSTOMISATIONS_SETTING_PRIMARY_COLOR = 'Primary color'
export const SITE_CUSTOMISATIONS_SETTING_SECONDARY_COLOR = 'Secondary color'
...
export const SUBHEADER_FEATURED_SECTION = 'Hand picked resources from the editors.'