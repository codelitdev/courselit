...
export const SITE_SETTINGS_STRIPE_PUBLISHABLE_KEY_TEXT = 'Stripe Publishable Key'
...
export const PAYMENT_INITIATION_FAILED = 'Payment processing failed. Please close this popup and try again.'
export const PAYMENT_VERIFICATION_FAILED = 'We were not able to verify your payment. Please try again.'
export const STRIPE_PUBLISHABLE_KEY_EMPTY = 'Stripe configuration is invalid. Please contact site admin.'
...
export const ENROLL_IN_THE_COURSE = 'Please enroll in the course to access this lesson.'
...
export const SITE_CUSTOMISATIONS_SETTING_CODEINJECTION_HEAD = 'Code Injection in <head>'
export const DISCARD_COURSE_CHANGES_POPUP_HEADER = 'Discard changes made to the course?'
export const FEATURED_SECTION_HEADER = 'Featured Resources'
export const EMPTY_PAGE_PLACEHOLDER = 'There is nothing here. Check back later.'
export const EMPTY_PAGE_CREATOR_USER_PLACEHOLDER = 'There is nothing here. Create fresh content for your users.'
...
export const SUBHEADER_BLOG_POSTS_SECTION = 'Browse our in-depth articles and tutorials.'
export const SUBHEADER_COURSES_SECTION = 'Learn new skills with our carefully crafted courses.'
export const SUBHEADER_FEATURED_SECTION = 'Hand picked resources by the editors.'
...
export const SUBHEADER_THEME_ADD_THEME_INPUT_PLACEHOLDER = 'Paste valid JSON here'
...
export const CONSOLE_MESSAGE_THEME_INVALID = 'The active MUI theme is invalid. Falling back to the default theme.'
