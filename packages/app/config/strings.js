...
export const BUTTON_NEW_GROUP_TEXT = "New group";
export const BUTTON_MANAGE_LESSONS_TEXT = "Manage Lessons";
export const BUTTON_LESSON_VIEW_GO_BACK = "Course Details";
...
export const BTN_LOGIN = "Sign In with Email";
...
export const COURSE_EDITOR_DESCRIPTION = "Content";
...
export const PERM_COURSE_MANAGE = "Create new content";
export const PERM_COURSE_MANAGE_ANY = "Manage any existing content";
export const PERM_COURSE_PUBLISH = "Change published status of content";
export const PERM_ENROLL_IN_COURSE = "Enroll in courses";
...
export const PERM_WIDGETS = "Manage widgets";
...
export const ERROR_SIGNIN = "Error generating sign in link. Try again.";
